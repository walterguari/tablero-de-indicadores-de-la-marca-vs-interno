...
def load_data(url):
    try:
        ...
        # Categorización para filtros cruzados
...
try:
    ...
    if not df.empty:
        ...
        # Estado persistente para filtros de comentarios
